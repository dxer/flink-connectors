...
public class ClickHouseSinkFunction extends RichSinkFunction<RowData> {
    ...
    public void invoke(RowData value, Context context) throws Exception {
        ...
        stmt.write().table(jdbcOptions.getTableName())
                .data(new ByteArrayInputStream(serialize), ClickHouseFormat.JSONEachRow)
                .addDbParam(ClickHouseQueryParam.MAX_PARALLEL_REPLICAS, MAX_PARALLEL_REPLICAS_VALUE)
                .send();
    }
